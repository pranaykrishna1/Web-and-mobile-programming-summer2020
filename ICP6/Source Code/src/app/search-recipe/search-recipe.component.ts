...
export class SearchRecipeComponent implements OnInit {
  ...
  recepieAppid = '&app_id=f3765f5a';
  recepieKey = '&app_key=3336183ad5f80fff187796f1a9f7a5b9';

  placesApi = 'https://api.foursquare.com/v2/venues/search?';
  clientdId = 'client_id=Y3042U53CXC0H3UMSQRJV5SP3ASZ2M5C4AJB0RH4H5VJYB32';
  clientSecret = '&client_secret=VDWY2SPWUACOLIT2W1FWBMPK0FAOR3WQKOCI2TTWJOP5TBFF';
  version = '&v=20180323';
  near1 = '&near=';
  ...
  getVenues() {
    ...
    if (this.placeValue != null && this.placeValue !== '' && this.recipeValue != null && this.recipeValue !== '') {
      this._http.get( this.placesApi  + this.clientdId + this.clientSecret + this.version+'&limit=6&ll=40.7243,-74.0018&query='
        + this.recipeValue + this.near1+ this.placeValue).subscribe((result: any) => {
        console.log(result);
